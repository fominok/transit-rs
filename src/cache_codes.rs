...
mod test {
    ...
    fn single_digit() {
        ...
        assert_eq!(cacher.cache("test1"), "^0");
        assert_eq!(cacher.cache("test2"), "^1");
        assert_eq!(cacher.cache("test3"), "^2");
        assert_eq!(cacher.cache("test4"), "^3");
        assert_eq!(cacher.cache("test5"), "^4");
        assert_eq!(cacher.cache("test6"), "^5");
        assert_eq!(cacher.cache("test7"), "^6");
        assert_eq!(cacher.cache("test8"), "^7");
        assert_eq!(cacher.cache("test9"), "^8");
        assert_eq!(cacher.cache("test10"), "^9");
        assert_eq!(cacher.cache("test11"), "^:");

        assert_eq!(cacher.cache("test5"), "^4");
        assert_eq!(cacher.cache("test6"), "^5");

        assert_eq!(cacher.cache("test12"), "^;");
    }
